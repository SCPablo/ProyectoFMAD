...
subtitle: ICAI. Máster en Big Data. Fundamentos Matemáticos del Análisis de Datos
  (FMAD).
author: Alvaro Rodriguez Gonzalez, Ignacio Perez-Cea, Pablo Sanz Caperote
...
# 4. Análisis Predictivo y Analítica Avanzada
...
## 4.2. Ajuste parámetros de control
...
## 4.3. Análisis sobre variable Complain
